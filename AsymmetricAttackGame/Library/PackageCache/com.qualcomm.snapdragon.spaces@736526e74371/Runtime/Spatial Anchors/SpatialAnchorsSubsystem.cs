...
namespace Qualcomm.Snapdragon.Spaces
{
    internal class SpatialAnchorsSubsystem : XRAnchorSubsystem
    {
        internal class SpatialAnchorsProvider : Provider
        {
            ...
            private int _tryAddAnchorsWorkerRunning = 1; // false = 0; true = 1
            ...
            public override void Start()
            {
                ...
                _tryAddAnchorsWorkerRunning = 1;
                _tryAddAnchorsWorker = new Thread(AddAnchorsWorker);
            ...
            {
                // Continuously try to query for anchors to add, until
                // the int '_tryAddAnchorsWorkerRunning' is set to 0
                while (Interlocked.CompareExchange(ref _tryAddAnchorsWorkerRunning, 1, 1) == 1)
                {
